        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="post-container">
                    ...
                    $offset = ($page - 1) * $limit;
                    $sql = "SELECT post.post_id, post.title, post.description, post.author, post.post_date, post.category, post.post_img, category.category_name, user.username FROM post 
