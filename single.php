        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="post-container">
                    ...
                    $sql = "SELECT post.post_id, post.title, post.description, post.post_date, post.category, post.post_img, post.author, category.category_name, user.username FROM post 
